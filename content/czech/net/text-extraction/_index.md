...
[Přečtěte si více](./extract-text-from-specific-areas-with-options/)
...
[Přečtěte si více](./search-text-by-pages/)
...
### [Extrahujte text v nezpracovaném režimu](./extract-text-in-raw-mode/)
