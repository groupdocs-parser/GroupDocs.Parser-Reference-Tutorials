...
[阅读更多](./extract-text-from-page-in-accurate-mode/)

## 以原始模式从页面提取文本
学习使用 GroupDocs.Parser for .NET 从文档页面高效提取文本的技术。本教程探讨原始模式提取，确保无缝检索各种文档格式的数据。

[阅读更多](./extract-text-from-page-in-raw-mode/)

## 以精确模式提取文本
使用 GroupDocs.Parser for .NET 探索准确的文本提取功能。本教程提供有关如何准确提取文本的分步指导，确保在 .NET 应用程序中可靠地提取数据。

[阅读更多](./extract-text-in-accurate-mode/)

## 以原始模式提取文本
使用 GroupDocs.Parser for .NET 轻松从 .NET 文档中提取文本。本教程提供了原始模式提取的简单易懂的说明，可无缝集成到您的应用程序中。

[阅读更多](./extract-text-in-raw-mode/)

## 提取文本结构
了解如何使用 GroupDocs.Parser for .NET 从各种文档格式中提取文本结构。本教程介绍如何有效提取文本结构以增强文档分析。

[阅读更多](./extract-text-structure/)

## 按关键字搜索文本
了解如何使用 GroupDocs.Parser for .NET 在文档中按关键字搜索文本。本教程使您能够根据特定关键字高效提取相关内容，从而增强文档分析能力。

[阅读更多](./search-text-by-keyword/)

## 按页搜索文本
使用 GroupDocs.Parser for .NET 解锁按页面搜索文本的功能。本教程将指导您根据页面级搜索条件从文档中提取特定内容，从而优化应用程序中的数据检索。

[阅读更多](./search-text-by-pages/)

## 通过正则表达式 (Regex) 搜索文本
了解如何使用 GroupDocs.Parser for .NET 在文档中使用正则表达式搜索文本。本教程提供高级文本搜索技术，使您能够根据正则表达式模式轻松提取特定内容。

[阅读更多](./search-text-by-regex/)

## 突出显示搜索文本
使用 GroupDocs.Parser for .NET 增强文本搜索功能和突出显示功能。本教程提供有关在文档中搜索和突出显示文本的见解，从而促进高效的数据分析和检索。

[阅读更多](./search-text-with-highlights/)

总之，这些教程涵盖了 GroupDocs.Parser for .NET 提供的各种文本提取和搜索功能。无论您是新手开发人员还是经验丰富的专业人士，这些资源都可以帮助您在 .NET 应用程序中充分利用文本提取的潜力。

## 文本提取教程
### [使用编码检测提取文本](./extract-text-with-encoding-detection/)
使用 GroupDocs.Parser for .NET 从带有编码检测的文档中提取文本。高效解析 .NET 应用程序中的各种格式。
### [提取并突出显示文本](./extract-and-highlight-text/)
了解如何使用 GroupDocs.Parser for .NET 从文档中提取和突出显示文本。在 .NET 项目中高效提取文本的简单步骤。
### [从特定区域提取文本](./extract-text-from-specific-areas/)
了解如何使用 GroupDocs.Parser for .NET 从文档的特定区域提取文本。简单的分步指南。
### [从页面的特定区域提取文本](./extract-text-from-specific-areas-on-page/)
了解如何使用 GroupDocs.Parser for .NET 从特定文档区域提取文本。为您的应用程序进行有针对性的精确文本提取。
### [使用选项从特定区域提取文本](./extract-text-from-specific-areas-with-options/)
了解如何使用 GroupDocs.Parser for .NET 从文档中的特定区域提取文本。通过本教程探索高级文本提取选项。
### [按目录 (TOC) 项目提取文本](./extract-text-by-toc-item/)
