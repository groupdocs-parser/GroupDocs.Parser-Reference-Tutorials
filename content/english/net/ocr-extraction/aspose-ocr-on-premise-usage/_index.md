---
title: Aspose OCR On-Premise Usage
linktitle: Aspose OCR On-Premise Usage
second_title: GroupDocs.Parser .NET API
description: 
type: docs
weight: 10
url: /net/ocr-extraction/aspose-ocr-on-premise-usage/
---
...
namespace GroupDocs.Parser.Examples.CSharp.AdvancedUsage.UsingOcr
{
    ...
    public class AsposeOcrOnPremise : OcrConnectorBase
    {
        static AsposeOcrOnPremise()
        {
            ...
            new Aspose.OCR.License().SetLicense("Your Sample File");
        }
